...
public class DbUtils {
    ...
    public static DbUtils create(Context context, String password,String dbName) {
        DaoConfig config = new DaoConfig(context);
        config.setPassword(password);
    ...
    public static DbUtils create(Context context,String password, String dbDir, String dbName) {
        DaoConfig config = new DaoConfig(context);
    ...
    public static DbUtils create(Context context, String password,String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbName(dbName);
        config.setPassword(password);
    ...
    public static DbUtils create(Context context,  String password,String dbDir, String dbName, int dbVersion, DbUpgradeListener dbUpgradeListener) {
        DaoConfig config = new DaoConfig(context);
        config.setDbDir(dbDir);
        config.setPassword(password);
        config.setDbName(dbName);
    ...
    public static DbUtils create(DaoConfig daoConfig,String password) {
        daoConfig.setPassword(password);
    ...
    public static class DaoConfig {
        ...
        public DaoConfig(Context context) {
            ...
            try {
                String path = getCacheDir(context,"database") ;
                this.dbDir = path;
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private SQLiteDatabase createDatabase(DaoConfig config) {
        ...
        if (!TextUtils.isEmpty(dbDir)) {
            ...
            if (dir.exists() || dir.mkdirs()) {
                ...
                Log.e("DB_Name",config.getDbName());
                result = SQLiteDatabase.openOrCreateDatabase(dbFile,config.getPassword(), null);
            }
        } else {
            result = SQLiteDatabase.openOrCreateDatabase(config.getDbDir(), config.getPassword(), null);
        }
        return result;
    }
